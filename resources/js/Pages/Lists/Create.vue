    ...
    <div class="max-w-4xl mx-auto px-6 py-10">
        ...
        <form @submit.prevent="submitForm" class="space-y-6">
            <div>
                <label
                    for="nombre"
                    class="block text-sm font-medium text-gray-700 dark:text-gray-800"
                >
                    Nombre de la lista
                </label>
                <input
            ...
            <div class="mt-6">
                <button
                    ...
                    class="flex gap-2 justify-center items-center mx-auto px-4 py-2 bg-green-600 text-white font-semibold rounded-md shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 disabled:bg-green-400 transition-all"
                >
