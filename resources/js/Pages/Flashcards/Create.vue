<template>
    ...
    <div class="max-w-3xl mx-auto py-2">
        <h1 class="text-center text-3xl font-semibold mb-8 text-gray-800">
            Añadir tarjeta nueva
        </h1>
        <form
            @submit.prevent="createFlashcard"
            class="space-y-2 bg-purple-300 p-6 rounded-lg shadow-lg"
        >
            <div class="flex items-center space-x-4">
                <label
                    for="palabra"
                    class="block text-sm font-semibold text-gray-800 w-1/3"
                    >Palabra:</label
                >
                <input
                    type="text"
                    ...
                    placeholder="Palabra"
                    required
                    class="w-2/3 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                    :class="{ 'border-red-500': form.errors.palabra }"
                />
            </div>
            <span v-if="form.errors.palabra" class="text-red-500 text-sm">{{
                form.errors.palabra
            }}</span>
            ...
            <div class="flex items-center space-x-4">
                ...
                <input
                    ...
                    required
                    class="w-2/3 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                    :class="{ 'border-red-500': form.errors.traduccion }"
                />
            </div>
            <span v-if="form.errors.traduccion" class="text-red-500 text-sm">{{
            ...
            <div class="flex items-center space-x-4">
                ...
                <input
                    ...
                    class="w-2/3 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                    :class="{ 'border-red-500': form.errors.cat_gramatical }"
                />
            </div>
            <span
                v-if="form.errors.cat_gramatical"
                class="text-red-500 text-sm"
                >{{ form.errors.cat_gramatical }}</span
            >
            ...
            <div class="flex items-center space-x-4">
                ...
                <input
                    ...
                    placeholder="opcional"
                    class="w-2/3 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                    :class="{ 'border-red-500': form.errors.pronunciacion }"
                />
            </div>
            <span
                v-if="form.errors.pronunciacion"
                class="text-red-500 text-sm"
                >{{ form.errors.pronunciacion }}</span
            >
            ...
            <div class="flex items-center space-x-4">
                ...
                <textarea
                    ...
                    required
                    class="w-2/3 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                    :class="{ 'border-red-500': form.errors.frase_ejemplo }"
                ></textarea>
            </div>
            <span
                v-if="form.errors.frase_ejemplo"
                class="text-red-500 text-sm"
                >{{ form.errors.frase_ejemplo }}</span
            >
            ...
            <span v-if="form.errors.notas" class="text-red-500 text-sm">{{
                form.errors.notas
            }}</span>
            ...
            <div class="flex justify-center">
                <button
                    ...
                    class="w-1/5 mt-2 px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-all focus:outline-none focus:ring-2 focus:ring-green-500 disabled:bg-gray-400"
                >
                    Añadir tarjeta
                </button>
            </div>
    ...
    <!-- Footer -->
    <footer
        class="bg-white dark:bg-gray-800 mt-2 py-10 text-center text-sm text-black dark:text-white/70"
    >
